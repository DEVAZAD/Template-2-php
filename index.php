...
<div class="container">
  ...
  <section class="section-pad" id="idea">
    ...
    <div class="grid-auto" style="margin-bottom:36px">
      <div class="card"><div class="idea-icon">&#x1F4A1;</div><h3>Innovation</h3><p style="margin-top:8px;color:var(--gray)">Let's Enrich Society by Enriching Lives. One at a time.</p></div>
      <div class="card"><div class="idea-icon">&#x1F91D;</div><h3>Collaboration</h3><p style="margin-top:8px;color:var(--gray)">By inspiring change. One nudge at a time.</p></div>
      <div class="card"><div class="idea-icon">&#x1F331;</div><h3>Sustainability</h3><p style="margin-top:8px;color:var(--gray)">By inspiring trust. One experience at a time.</p></div>
    </div>
  ...
  <section class="section-pad" id="partners">
    ...
    <div class="partners-grid">
      <div class="card partner-card"><div class="partner-logo"></div><h3>Heritage Trust</h3></div>
      <div class="card partner-card"><div class="partner-logo"></div><h3>Cultural Connect</h3></div>
      <div class="card partner-card"><div class="partner-logo"></div><h3>Tradition Keepers</h3></div>
      <div class="card partner-card"><div class="partner-logo"></div><h3>Indigenous Voices</h3></div>
    </div>
  </section>
      ...
      <div class="contact-info-box">
        <div class="card">
          ...
          <div class="contact-row">
            ...
            <div><h4>Location</h4><p>Pangin, Arunachal Pradesh, India</p></div>
          </div>
          <div class="contact-row">
            <div class="contact-icon">&#x1F4DE;</div>
            <div><h4>Phone</h4><p>+91 12345 67890</p></div>
          </div>
          <div class="contact-row">
            <div class="contact-icon">&#x2709;&#xFE0F;</div>
            <div><h4>Email</h4><p>info@abcel.com</p></div>
          </div>
        </div>
        <div class="card">
